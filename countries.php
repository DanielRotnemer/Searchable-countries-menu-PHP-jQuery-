<?php
    ...
    $myCountryFlagSrc = 'http://localhost/utilities/flags/blank.gif';
        ...
        <div class="menu-wrapper">
            ...
            foreach ($countries as $index => $countryData)
            {
                ...
                if ($code == 'gf' || $code == 'gp' || $code == 'io' || $code == 'pm' || $code == 're' || $code == 'xk') {
                    $image = 'src="http://localhost/utilities/alt_flags'.$code.'.jpg"';
                }
                else {
                    $image = 'src="http://localhost/utilities/flags/blank.gif" class="flag flag-'.$code.'"';
                }
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="http://localhost/CountriesMenu/flags/flags.css"/>
        <link rel="stylesheet" href="http://localhost/CountriesMenu/flags/flags.min.css"/>
        <script src="countries.js?c=<?php echo time(); ?>"></script>
        <link rel="stylesheet" href="http://localhost/CountriesMenu/fonts/proximanova/stylesheet.css"/>
        <link rel="stylesheet" href="http://localhost/CountriesMenu/fonts/proximanova_bold/stylesheet.css"/>
    </head>
    <body>
